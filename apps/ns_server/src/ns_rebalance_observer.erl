...
construct_total_stat_info_json(#total_stat_info{total_time = TT,
    ...
    {[{averageTime, average(TT, CC)}, {totalTime, TT}] ++ CountJson}.
                         ...
                         {vbucketLevelInfo,
                          {[{move,
                             {[{averageTime, _},
                               ...
                               {totalCount, 1},
                               {remainingCount, 0}]}},
                            {backfill, {[{averageTime, _}, {totalTime, _}]}},
                            ...
                            {snapshot_waiting,{[{averageTime, _},
                                                {totalTime, _}]}},
                            {takeover, {[{averageTime, _}, {totalTime, _}]}},
                            {persistence, {[{averageTime, _}, {totalTime, _}]}},
                            {vbucketInfo,
                             [{[{id,0},
                               {beforeChain, [n_0, n_1]},
                                {afterChain, [n_1, n_0]},
