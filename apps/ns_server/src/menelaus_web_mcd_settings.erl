...
ns_config_setting_names() ->
    [{max_connections, {int, 2000, ?MAX_32BIT_SIGNED_INT}},
     ...
     {num_quicknonio_threads, fun validate_num_storage_auxio_nonio_threads/1},
     {num_slowio_threads, fun validate_num_storage_auxio_nonio_threads/1},
     {num_storage_threads, fun validate_num_storage_auxio_nonio_threads/1},
     {num_io_threads_per_core, fun validate_num_storage_auxio_nonio_threads/1},
...
enterprise_only(throttle_enabled) -> true;
enterprise_only(read_unit_size) -> true;
enterprise_only(write_unit_size) -> true;
enterprise_only(node_capacity) -> true;
enterprise_only(_) -> false.

validate_chronicle_params_for_cluster_compat_and_edition(Params) ->
