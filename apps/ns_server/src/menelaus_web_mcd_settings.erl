...
config_upgrade_to_phoenix(Config) ->
    config_upgrade_to_phoenix_global_memcached_cfg(Config) ++
    config_upgrade_to_phoenix_node_memcached_cfg(Config).
...
-ifdef(TEST).
upgrade_config_from_76_to_phoenix_test_setup() ->
...
upgrade_config_from_76_to_phoenix_t() ->
    ...
    Txns = config_upgrade_to_phoenix([TestCfg1]),
...
upgrade_config_from_76_to_phoenix_test_() ->
    {setup, fun upgrade_config_from_76_to_phoenix_test_setup/0,
            fun upgrade_config_from_76_to_phoenix_test_teardown/1,
            fun upgrade_config_from_76_to_phoenix_t/0}.
-endif.
