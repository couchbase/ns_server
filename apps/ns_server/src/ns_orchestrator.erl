...
%% The second argument can be a boolean or a map. Pre-Phoenix compat this will
%% be a boolean. Post-Phoenix compat this will be a map. This can be update
%% once we move the minimum compat version beyond Phoenix.
...
failover(Nodes, AllowUnsafe) when is_boolean(AllowUnsafe) ->
    %% Pre-Phoenix compat function clause.
...
%% Pre-Phoenix compat function. start_graceful_failover/2 is the new function.
