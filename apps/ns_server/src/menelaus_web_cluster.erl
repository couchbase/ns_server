...
call_add_node(OtherScheme, OtherHost, OtherPort, HiddenAuth, AFamily,
    ...
    case Res of
        ...
        {error, rest_error, M, {bad_status, 401, _Msg}} ->
            ...
            {error, rest_error, <<M/binary, " ", Details/binary>>};
        {error, rest_error, M,
...
%% operation.
parse_expected_topology_params_from_req(Req, IsPhoenix) ->
    Params = mochiweb_request:parse_post(Req),
    parse_expected_topology_params(Params, IsPhoenix).
    ...
    case ActiveNodes =:= undefined andalso
        ...
        false ->
            case IsPhoenix of
                false ->
                    {error,
                     "Cannot use expected topology in pre-Phoenix cluster"};
                true ->
...
do_handle_start_hard_failover(Req, FailoverBody) ->
    case parse_hard_failover_args(Req) of
        {ok, Nodes, AllowUnsafe} ->
            ...
            case parse_expected_topology_params_from_req(Req, IsPhoenix) of
                {error, Error} ->
                ...
                Opts ->
                    case IsPhoenix of
                        ...
                        true ->
                            ...
                            %% post-Phoenix such that we can eventually remove
                            %% the old non-map API.
                            failover_audit_and_reply(
                ...
                Opts ->
                    case IsPhoenix of
                        ...
                        true ->
                            ...
                            %% API post-Phoenix such that we can
...
parse_rebalance_params(Params) ->
    ...
    IsPhoenix = cluster_compat_mode:is_cluster_phoenix(),
    BaseMap =
        case parse_expected_topology_params(Params, IsPhoenix) of
            {error, TopologyError} ->
                throw(TopologyError);
            TopologyArgs ->
                TopologyArgs
