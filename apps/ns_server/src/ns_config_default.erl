    ...
    [{{node, node(), config_version}, get_current_version()},
     ...
     {{node, node(), memcached_defaults},
      [{max_connections, 65000},
       ...
       {num_quicknonio_threads, <<"default">>},
       {num_slowio_threads, <<"default">>},
       {num_storage_threads, <<"default">>},
       {num_io_threads_per_core, <<"default">>},
     ...
     {{node, node(), memcached_config},
      {[
        ...
        {num_quicknonio_threads, num_quicknonio_threads},
        {num_slowio_threads, num_slowio_threads},
        {num_storage_threads, num_storage_threads},
        {num_io_threads_per_core, num_io_threads_per_core},
        ...
        {fusion_num_uploader_threads, fusion_num_uploader_threads},
        {fusion_num_migrator_threads, fusion_num_migrator_threads},
        {fusion_max_pending_upload_bytes, fusion_max_pending_upload_bytes},
        {fusion_max_pending_upload_bytes_lwm_percentage,
         fusion_max_pending_upload_bytes_lwm_percentage},
        {dcp_backfill_moves_per_node,
         {memcached_config_mgr, get_dcp_backfill_moves_per_node, []}},
        {file_based_backfill_moves_per_node,
         {memcached_config_mgr, get_file_based_backfill_moves_per_node, []}},
