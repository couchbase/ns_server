    ...
    case proplists:get_value(<<"autogeneratedCA">>, NodeKVList) of
        ...
        Cert when Cert =/= undefined, CanRewriteCerts ->
            NodeCert = proplists:get_value(<<"autogeneratedCert">>,
                                           NodeKVList),
            NodeKey =
                %% The key is wrapped in {otpCookie, } to make sure it
                %% is sanitized before getting logged.
...
validate_local_node_certificate_san() ->
    ...
    CertIsNotOK =
        case
            ...
            true ->
                NodeCertProps = ns_server_cert:get_node_cert_info(node()),
...
do_add_node_with_connectivity(Scheme, RemoteAddr, RestPort, HiddenAuth,
    ...
    MustUseHttps =
        ...
        (proplists:is_defined(<<"autogeneratedKey">>, Props1) or IsEnterprise),
