...
is_interesting_to_watchers({kv_storage_limit, _}) -> true;
is_interesting_to_watchers({index_storage_limit, _}) -> true;
is_interesting_to_watchers({fts_storage_limit, _}) -> true;
