...
class MnWizardTermsAndConditionsComponent extends MnLifeCycleHooksToStream {
  ...
  getClusterInitConfig([, services, isEnterprise]) {
    ...
    return Object.assign({
        ...
        sendStats: isEnterprise ? this.wizardForm.termsAndConditions.get("enableStats").value : true,
  ...
  render() {
    const { isEnterprise, majorMinorVersion, servicesHttpError, license, termsHref, defaultFormSubmitted } = this.state;
    ...
    return (
      <div className="panel dialog-med dialog dialog-wizard">
        ...
        <FieldGroup strict={false} control={this.form.group} render={({submitted}) => (
          <form
            onSubmit={(e) => {
              e.preventDefault();
            ...
            <div className="panel-content">
              ...
              <FieldControl
                ...
                render={({ touched, value }) =>
                  (<div className="error error-form" hidden={!(touched || submitted || defaultFormSubmitted) || !!value}>
                    ...
                    render={({ handler }) => (
                      <>
                        <input
                          ...
                          {...handler('checkbox')}
                        />
                        <label className="text-small" htmlFor="for-accept-terms">
                          I accept the{" "}
                          <a
                            href={termsHref}
                            target="_blank"
