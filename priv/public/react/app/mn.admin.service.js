...
class MnAdminServiceClass {
  constructor(http, mnPrettyVersionPipe, mnPoolsService) {
    ...
    this.stream.compatVersion80 =
      this.stream.clusterCompatibility.pipe(map(R.flip(R.gte)(encodeCompatVersion(8, 0))));
...
const MnAdminService = new MnAdminServiceClass(HttpClient, MnPrettyVersion, MnPoolsService);
