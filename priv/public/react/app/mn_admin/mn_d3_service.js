...
function mnD3ServiceFactory() {
  ...
  class mnD3Tooltip extends mnD3 {
    ...
    init() {
      ...
      this.tipBox.node().addEventListener('mousemove', this.setMouseMoveEvent.bind(this));
      this.tipBox.node().addEventListener('mousemove', this.drawTooltipThrottle);
      this.tipBox.node().addEventListener('mouseout', this.hideTooltip.bind(this));
      if (this.opt.isPauseEnabled) {
        this.tipBox.node().addEventListener('mousemove', this.cancelLineAnimation.bind(this));
      }
