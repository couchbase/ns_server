      ...
      <>
        ...
        <div style={{ paddingBottom: '120px' }}>
          <div className="row items-bottom margin-bottom-half flex-wrap">
            {poolDefault.compat.atLeast70 && (
              <div className="column flex-grow-1-5">
                <h5>Bucket & Scope</h5>
                <MnKeyspaceSelector
                  className="mn-keyspace-selector"
                  service={vm.mnCollectionSelectorService}
                />
              </div>
            )}
            <MnSelect
          ...
          {state?.indexes.length ? (
            ...
            <div className="zero-content">You have no GSI indexes yet.</div>
          )}
        </div>
      </>
    );
