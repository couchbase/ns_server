...
function setHideNavSidebar(value) {
  mnPoolDefault.export.next(Object.assign(structuredClone(mnPoolDefault.export.getValue()), { hideNavSidebar: value }));
}
...
function get(params, mnHttpParams) {
  ...
  request = Promise.all([
    ...
    mnPoolDefault.export.next(Object.assign(structuredClone(mnPoolDefault.export.getValue()), poolDefault));
