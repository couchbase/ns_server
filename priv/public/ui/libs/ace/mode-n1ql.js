...
(function() {
  ...
  var keywords = (
      ...
      "ROLLBACK|ROW|ROWS|SATISFIES|SAVEPOINT|SCHEMA|SELECT|SELF|SEMI|SET|SHOW|SOME|START|STATISTICS|STRING|SYSTEM|THEN|TIES|TO|" +
      "TRAN|TRANSACTION|TRIGGER|TRUNCATE|UNBOUNDED|UNDER|UNION|UNIQUE|UNKNOWN|UNNEST|UNSET|UPDATE|UPSERT|USE|USER|USING|" +
