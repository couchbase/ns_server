export default mnXDCRCreateDialogController;

function mnXDCRCreateDialogController($scope, $uibModalInstance, mnPromiseHelper, mnXDCRService, replicationSettings, mnAlertsService) {
  var vm = this;
