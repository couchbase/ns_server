...
export default mnDocumentsEditingController;
...
function mnDocumentsEditingController($scope, $state, $uibModal, mnDocumentsEditingService, mnPromiseHelper) {
  ...
  function hasDocUpsert() {
    return $scope.rbac.cluster.bucket[$state.params.commonBucket] &&
      $scope.rbac.cluster.bucket[$state.params.commonBucket].data.docs.upsert;
  }
