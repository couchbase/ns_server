...
export default mnXDCREditDialogController;

function mnXDCREditDialogController($uibModalInstance, mnPromiseHelper, mnXDCRService, currentSettings, globalSettings, id, source, mnPools, mnPoolDefault) {
  var vm = this;
