...
(function($) {
    function Plot(placeholder, data_, options_, plugins) {
        ...
        var series = [],
            options = {
                ...
                colors: ["#b3cfef", "#afd8f8", "#cb4b4b", "#4da74d", "#9440ed"],
                legend: {
                    show: true,
  ...
  function plotStatGraph(config) {
    ...
    var preparedQ = mnPrepareQuantityFilter(yTicks[yTicks.length-1], options.isBytes ? 1024 : 1000);
    ...
    var plotOptions = {
      xaxis: {
        ...
        tickFormatter: function (val, axis) {
          ...
          return [mnTruncateTo3DigitsFilter(val/preparedQ[0]), preparedQ[1]].join('');
        },
        min: 0,
        max: graphMax,
        ticks: yTicks
