...
(function() {
  ...
  function runInContext(context) {
    ...
    function baseDelay(func, wait, args, fromIndex) {
      ...
      return setTimeout(function() { func.apply(undefined$1, baseSlice(args, fromIndex)); }, wait);
    }
    ...
    function baseInvoke(collection, methodName, args) {
      ...
      baseEach(collection, function(value) {
        ...
        result[++index] = func ? func.apply(value, args) : undefined$1;
      });
      return result;
    }
    ...
    function baseIsMatch(object, props, values, strictCompareFlags, customizer) {
      ...
      while (++index < length) {
        ...
        if (noCustomizer && strictCompareFlags[index]) {
          ...
          result = customizer ? customizer(objValue, srcValue, key) : undefined$1;
          if (typeof result == 'undefined') {
    ...
    function sortByAll(collection) {
      ...
      baseEach(collection, function(value) {
        ...
        while (length--) {
          criteria[length] = value == null ? undefined$1 : value[props[length]];
        }
    ...
    function defaults(object) {
      ...
      return assign.apply(undefined$1, args);
    }
